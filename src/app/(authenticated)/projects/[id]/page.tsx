...
import { BillablesTab } from './tabs/BillablesTab'
import { PerformanceMultiplierCard } from './components/PerformanceMultiplierCard'
import { PerformanceHistoryChartContent } from './components/PerformanceHistoryChartContent'
import {
  PROJECT_INFO_EXTRA_FIELDS,
  PROJECT_INFO_EXTRA_PHONE_COLUMNS,
  PROJECT_INFO_GROUPS,
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="dashboard">
        ...
        <DashboardTab
          ...
          loadingAllTime={loadingAllTime}
          timeDistributionView={timeDistributionView}
          setTimeDistributionView={setTimeDistributionView}
          performanceOverTime={performanceOverTime || []}
          loadingPerformanceOverTime={loadingPerformanceOverTime}
          selectedPhaseFilter={selectedPhaseFilter}
          setSelectedPhaseFilter={setSelectedPhaseFilter}
          phases={phases || []}
          PerformanceMultiplierCard={PerformanceMultiplierCard}
          PerformanceHistoryChartContent={PerformanceHistoryChartContent}
        />
        ...
        <ApplicationsTab
          projectId={projectId}
          applicationsByAgency={applicationsByAgency}
          permitSelectionsById={permitSelectionsById}
          permitById={permitById}
          requiredCatalogById={requiredCatalogById}
        ...
        {perms.canSeeProjectTab('phases') && (
          <PhasesTab
            ...
            phases={phases}
            totalFee={totalFee}
            totalInvoicedFromInvoices={totalInvoicedFromInvoices}
            totalRemainingForTable={totalRemainingForTable}
            totalReimbursableInvoicedFromInvoiceLines={totalReimbursableInvoicedFromInvoiceLines}
            billedByPhaseName={billedByPhaseName}
            laborByPhase={laborByPhase}
          />
        )}

        {perms.canSeeProjectTab('billables') && (
          <BillablesTab
            loadingProjectBillables={loadingProjectBillables}
            projectBillables={projectBillables}
            selectedBillablesMonth={selectedBillablesMonth}
            setSelectedBillablesMonth={setSelectedBillablesMonth}
            selectedBillablesMonthLabel={selectedBillablesMonthLabel}
            billablesMonthOptions={billablesMonthOptions}
            normalizedProjectNumber={normalizedProjectNumber}
            projectName={project?.name}
          />
        )}
        ...
        {perms.canSeeProjectTab('labor') && (
          <TimeTab
            ...
            timeFilterEmployee={timeFilterEmployee}
            setTimeFilterEmployee={setTimeFilterEmployee}
            timeFilterPhase={timeFilterPhase}
            setTimeFilterPhase={setTimeFilterPhase}
        ...
        {perms.canSeeProjectTab('expenses') && (
          <ExpensesTab
            ...
            subcontractContracts={subcontractContracts}
            normalizedProjectNumber={normalizedProjectNumber}
            projectId={projectId}
          />
        )}
        ...
        {perms.canSeeProjectTab('contracts') && (
          <ContractsTab
            projectId={projectId}
            loadingSubcontractContracts={loadingSubcontractContracts}
            loadingExpenses={loadingExpenses}
